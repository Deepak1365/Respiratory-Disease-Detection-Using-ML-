...
from Augmentation import add_noise, shift, stretch # Import necessary functions from Augmentation module
...
def InstantiateAttributes(dir_):
    ...
    features ), from the audio data. Augmentation of sound data by adding Noise, stretching and shifting 
